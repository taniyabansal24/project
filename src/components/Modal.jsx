...
export default function Modal({isOpen, setIsOpen}) {
  return (
    <div className={`fixed z-10 inset-0 flex items-center justify-center px-4 bg-black/40 ${isOpen ? '' : 'hidden'}`}>
      <div className="about-section items-center justify-center flex flex-col md:flex-row rounded-lg grow relative max-w-[19rem] bg-[#191919] p-4 shadow-lg h-fit md:h-[700px]">

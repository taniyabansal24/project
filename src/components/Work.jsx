...
{/* Veer Raghav Project */}
        <div className="flex flex-col sm:flex-row gap-4 mt-8 sm:gap-[80px] items-center sm:mt-20 relative">
          ...
          <div className="w-full">
            ...
            Is a fully functional hotel booking platform built using Next.js and Tailwind CSS. This website allows users to seamlessly browse available rooms, check details, and book their stay at Veer Raghav Hotel. With a clean and responsive UI, the platform ensures a smooth and user-friendly experience.
            </p>
